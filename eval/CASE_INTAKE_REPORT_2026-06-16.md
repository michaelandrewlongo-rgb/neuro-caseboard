...
| skullbase_pituitary_endonasal | Skull base | - x(midline) | - OK | OK | OK | 3 | OK |
...
| endovascular_acom_coiling | Vascular | - x(midline) | - OK | OK | OK | 3 | OK |
| endovascular_basilar_coiling | Vascular | - x(midline) | - OK | OK | OK | 3 | OK |
| endovascular_ica_flow_diverter | Vascular | right OK | - OK | OK | OK | 3 | OK |
| endovascular_mca_thrombectomy | Vascular | right x(left) | - OK | OK | OK | 3 | OK |
...
| neurooncology_intraventricular_tumor | Neuro-oncology | right x(left) | - OK | OK | OK | 3 | OK |
...
| pediatric_craniopharyngioma | Pediatric | - x(midline) | - OK | OK | OK | 3 | OK |
| pediatric_myelomeningocele_closure | Pediatric | - x(midline) | - OK | OK | OK | 3 | OK |

## Scores
- Deterministic side: **20/27**
...
**WS-1 acceptance: NOT MET** (side/level extracted, goal+comorbidities captured, missing_critical conservative).
